...
public class citasReactivaServiceImpl implements IcitasReactivaService {
    ...
    @Override
    public Mono<facturaDTOReactiva> save(facturaDTOReactiva citasDTOReactiva) {
    ...
    @Override
    public Mono<facturaDTOReactiva> update(String id, facturaDTOReactiva citasDTOReactiva) {
    ...
    @Override
    public Flux<facturaDTOReactiva> findByIdPaciente(String idPaciente) {
